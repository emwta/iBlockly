...
Blockly.Msg.ARD_COMPONENT_WARN1 = "sdfdsfsdfsdfdsgflksjdhfklsdhfjksdh";  // untranslated
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "Void Loop ()                      ";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "Void Setup ()                    ";  // untranslated
...
Blockly.Msg.ARD_TOgetFieldValueNE_PIN = "Tone PIN#";  // untranslated
...
Blockly.Msg.ATX = "ATX-2";  // untranslated
Blockly.Msg.AUTH = "Please authorize this app to enable your work to be saved and to allow it to be shared by you.";  // untranslated
Blockly.Msg.Board = "Board";  // untranslated
Blockly.Msg.Board_HELP = "www.doc.inex.co.th";  // untranslated
Blockly.Msg.Board_TIP = "Board From INEX, This block for include library robot board ";  // untranslated
Blockly.Msg.CENTER_X = "             Center X:";  // untranslated
Blockly.Msg.CENTER_Y = "Center Y:";  // untranslated
...
Blockly.Msg.END_DEG = "End Degree:";  // untranslated
Blockly.Msg.END_X = "End X:";  // untranslated
Blockly.Msg.END_Y = "End Y";  // untranslated
...
Blockly.Msg.GETHELP = "wwww.doc.inex.co.th";  // untranslated
Blockly.Msg.GLCD_CIR = "GLCD CIRCLE";  // untranslated
Blockly.Msg.GLCD_CLEAR = "GLCD Clear Screen";  // untranslated
Blockly.Msg.GLCD_COLOR = "  Color:";  // untranslated
Blockly.Msg.GLCD_COLOR_TEXT = "GLCD Text Color";  // untranslated
Blockly.Msg.GLCD_DISPLAY_TIPC = "Set text size for display on GLCD";  // untranslated
Blockly.Msg.GLCD_DISPLAY_TIPS = "Set text color for display on GLCD";  // untranslated
Blockly.Msg.GLCD_FILL_ARC = "GLCD Arc";  // untranslated
Blockly.Msg.GLCD_FILL_CIR = "GLCD Fill Circle";  // untranslated
Blockly.Msg.GLCD_FILL_LINE = "GLCD Line";  // untranslated
Blockly.Msg.GLCD_FILL_REC = "GLCD Fill Rectangle";  // untranslated
Blockly.Msg.GLCD_FILL_SCR = "Fill Screen Color";  // untranslated
Blockly.Msg.GLCD_HEIGHT = "Height:";  // untranslated
Blockly.Msg.GLCD_REC = "GLCD Rectangle";  // untranslated
Blockly.Msg.GLCD_SHOW_ROW = "GLCD Row";  // untranslated
Blockly.Msg.GLCD_SIZE = "GLCD Text Size";  // untranslated
Blockly.Msg.GLCD_TEXT = "Text";  // untranslated
Blockly.Msg.GLCD_TEXT_BACKGROUND = "Set Text Background";  // untranslated
Blockly.Msg.GLCD_TEXT_FORMAT = "Format:";  // untranslated
Blockly.Msg.GLCD_TEXT_PRE = "Prefix:";  // untranslated
Blockly.Msg.GLCD_TEXT_ROW = "Row:";  // untranslated
Blockly.Msg.GLCD_TEXT_SUB = "Subfix:";  // untranslated
Blockly.Msg.GLCD_TEXT_TIP = "Display value on GLCD";  // untranslated
Blockly.Msg.GLCD_TEXT_VALUE = "GLCD Show Value:";  // untranslated
Blockly.Msg.GLCD_WIDTH = "Width:";  // untranslated
Blockly.Msg.GLCD_X_AXIS = "                X:";  // untranslated
Blockly.Msg.GLCD_Y_AXIS = " Y:";  // untranslated
Blockly.Msg.HELP = "Ajuda";
Blockly.Msg.INLINE_INPUTS = "Entradas en linha";
Blockly.Msg.LED8_INPUT = "Byte";  // untranslated
Blockly.Msg.LED8_PIN = "LED8 Pin";  // untranslated
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Return one of the common constants: Ã?â‚¬ (3.141Ã¢â‚¬Â¦), e (2.718Ã¢â‚¬Â¦), Ã?? (1.618Ã¢â‚¬Â¦), sqrt(2) (1.414Ã¢â‚¬Â¦), sqrt(Ã‚Â½) (0.707Ã¢â‚¬Â¦), or Ã¢?? (infinity).";  // untranslated
...
Blockly.Msg.MATH_MODULO_TITLE = "remainder of %1 Modulo %2";  // untranslated
...
Blockly.Msg.ME = "Ieu";
Blockly.Msg.MOTOR_MOVE = "Move";  // untranslated
Blockly.Msg.MOTOR_SPEED = "Speed";  // untranslated
Blockly.Msg.MOTOR_SPIN = "Spin";  // untranslated
Blockly.Msg.MOTOR_TURN = "Turn";  // untranslated
Blockly.Msg.Motor2_L = "Left";  // untranslated
Blockly.Msg.Motor2_R = "Right";  // untranslated
Blockly.Msg.MotorSL = "SpinLeft";  // untranslated
Blockly.Msg.MotorSR = "SpinRight";  // untranslated
Blockly.Msg.Motor_BK = "Backward";  // untranslated
Blockly.Msg.Motor_Backward2 = "Backward2";  // untranslated
Blockly.Msg.Motor_FD = "Forward";  // untranslated
Blockly.Msg.Motor_Fiel_Speed = "Speed";  // untranslated
Blockly.Msg.Motor_Fiel_choose = "Motor";  // untranslated
Blockly.Msg.Motor_Forward2 = "Forward2";  // untranslated
Blockly.Msg.Motor_SL = "TurnLeft";  // untranslated
Blockly.Msg.Motor_SR = "TurnRight";  // untranslated
Blockly.Msg.Motor_Speed = "Input Speed Motor by Number 0-100";  // untranslated
Blockly.Msg.Motor_Stop = "Motor Stop";  // untranslated
...
Blockly.Msg.SENSOR_ANALOG = "Analog";  // untranslated
Blockly.Msg.SENSOR_DIGITAL = "Read Digital";  // untranslated
Blockly.Msg.SENSOR_IR = "IR Range";  // untranslated
Blockly.Msg.SENSOR_SONAR = "Sonar Range";  // untranslated
Blockly.Msg.SENSOR_TEMP = "Temperature";  // untranslated
Blockly.Msg.SERVO_TIP = "Input Angle Servo by Number 0-180 or Other";  // untranslated
Blockly.Msg.SERVO_TITLE = "Servo PIN";  // untranslated
Blockly.Msg.SERVO_TITLE1 = "Angle";  // untranslated
Blockly.Msg.START_DEG = "Start Degree:";  // untranslated
Blockly.Msg.START_X = "Start X:";  // untranslated
Blockly.Msg.START_Y = "Start Y:";  // untranslated
Blockly.Msg.Sound_Beep = "Beep";  // untranslated
Blockly.Msg.Sound_FRE = "Frequency";  // untranslated
Blockly.Msg.Sound_PIN = "Sound PIN";  // untranslated
Blockly.Msg.Sound_TIME = "Time";  // untranslated
Blockly.Msg.Switch = "OK Switch";  // untranslated
...
Blockly.Msg.TOOLTIP_AO = "Stop all motor";  // untranslated
Blockly.Msg.TOOLTIP_BACKWARD2 = "This block can be adjusted speed backward 2 motor is different.";  // untranslated
Blockly.Msg.TOOLTIP_FORWARD2 = "This block can be adjusted speed forward 2 motor is different.";  // untranslated
Blockly.Msg.TOOLTIP_MOTORCHOOSE = "This block can be adjusted motor various 1 motor, 6 motor and set speed 0-100.";  // untranslated
Blockly.Msg.TOOLTIP_MOVE = "Motor Move Forward or Backward set speed 0-100.";  // untranslated
Blockly.Msg.TOOLTIP_SPIN = "Motor Move Spin Right or Left, One side motor reverse spin. can set speed 0-100.";  // untranslated
Blockly.Msg.TOOLTIP_TURN = "Motor Move Turn Right or Left, One side motor stop set speed 0-100.";  // untranslated
Blockly.Msg.UART_GET = "uart1 getkey";  // untranslated
...
Blockly.Msg.XIO = "XIO";  // untranslated
