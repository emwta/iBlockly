...
/// url - Information about the mathematical constants Pi (Ã?â‚¬), e, the golden ratio (Ã??), Ã¢?? 2, Ã¢?? 1/2, and infinity (Ã¢??).
Blockly.Msg.MATH_CONSTANT_HELPURL = 'https://en.wikipedia.org/wiki/Mathematical_constant';
/// tooltip - Provides the specified [https://en.wikipedia.org/wiki/Mathematical_constant mathematical constant].
Blockly.Msg.MATH_CONSTANT_TOOLTIP = 'Return one of the common constants: Ã?â‚¬ (3.141Ã¢â‚¬Â¦), e (2.718Ã¢â‚¬Â¦), Ã?? (1.618Ã¢â‚¬Â¦), sqrt(2) (1.414Ã¢â‚¬Â¦), sqrt(Ã‚Â½) (0.707Ã¢â‚¬Â¦), or Ã¢?? (infinity).';
...
/// dropdown - A number is [https://en.wikipedia.org/wiki/Prime prime] if it cannot be evenly divided by any positive integers except for 1 and itself.  For example, 5 is prime, but 6 is not because 2 Ãƒâ€�? 3 = 6.
...
Blockly.Msg.MATH_MODULO_TITLE = 'remainder of %1 Modulo %2';
...
Blockly.Msg.ARD_TOgetFieldValueNE_PIN = 'Tone PIN#';
...
Blockly.Msg.ARD_FUN_RUN_SETUP = 'Void Setup ()                    ';
Blockly.Msg.ARD_FUN_RUN_LOOP = 'Void Loop ()                      ';
...
Blockly.Msg.ARD_COMPONENT_WARN1 = 'sdfdsfsdfsdfdsgflksjdhfklsdhfjksdh';
...
//New Board create
Blockly.Msg.Motor_Speed = 'Input Speed Motor by Number 0-100';
Blockly.Msg.Motor_FD = 'Forward';
Blockly.Msg.Motor_SL = 'TurnLeft';
Blockly.Msg.Motor_SR = 'TurnRight';
Blockly.Msg.Motor_BK = 'Backward';
Blockly.Msg.Motor_Fiel_choose = 'Motor';
Blockly.Msg.Motor_Fiel_Speed = 'Speed';
Blockly.Msg.Motor_Stop = 'Motor Stop';
Blockly.Msg.SERVO_TIP = 'Input Angle Servo by Number 0-180 or Other';
Blockly.Msg.SERVO_TITLE = 'Servo PIN';
Blockly.Msg.SERVO_TITLE1 = 'Angle';
Blockly.Msg.GETHELP = 'wwww.doc.inex.co.th';
Blockly.Msg.Motor_Forward2 = 'Forward2';
Blockly.Msg.Motor_Backward2 = 'Backward2';
Blockly.Msg.Motor2_L = 'Left';
Blockly.Msg.Motor2_R = 'Right';
Blockly.Msg.MotorSL = 'SpinLeft';
Blockly.Msg.MotorSR = 'SpinRight';
Blockly.Msg.Switch = 'OK Switch';
Blockly.Msg.ATX = 'ATX-2';
Blockly.Msg.XIO = 'XIO';
Blockly.Msg.Board = 'Board';
Blockly.Msg.Board_TIP = 'Board From INEX, This block for include library robot board ';
Blockly.Msg.Board_HELP = 'www.doc.inex.co.th';
Blockly.Msg.Sound_Beep = 'Beep';
Blockly.Msg.Sound_PIN = 'Sound PIN';
Blockly.Msg.Sound_FRE = 'Frequency';
Blockly.Msg.Sound_TIME = 'Time';
Blockly.Msg.LED8_PIN = 'LED8 Pin';
Blockly.Msg.LED8_INPUT = 'Byte';
Blockly.Msg.GLCD_SHOW_ROW = 'GLCD Row';
Blockly.Msg.GLCD_TEXT = 'Text';
Blockly.Msg.GLCD_TEXT_TIP = 'Display value on GLCD';
Blockly.Msg.GLCD_TEXT_VALUE = 'GLCD Show Value:';
Blockly.Msg.GLCD_TEXT_FORMAT = 'Format:';
Blockly.Msg.GLCD_TEXT_ROW = 'Row:';
Blockly.Msg.GLCD_TEXT_PRE = 'Prefix:';
Blockly.Msg.GLCD_TEXT_SUB = 'Subfix:';
Blockly.Msg.GLCD_SIZE = 'GLCD Text Size';
Blockly.Msg.GLCD_COLOR_TEXT = 'GLCD Text Color';
Blockly.Msg.GLCD_TEXT_BACKGROUND = 'Set Text Background';
Blockly.Msg.GLCD_DISPLAY_TIPS = 'Set text color for display on GLCD';
Blockly.Msg.GLCD_DISPLAY_TIPC = 'Set text size for display on GLCD';
Blockly.Msg.SENSOR_DIGITAL = 'Read Digital';
Blockly.Msg.SENSOR_ANALOG = 'Analog';
Blockly.Msg.SENSOR_IR = 'IR Range';
Blockly.Msg.SENSOR_SONAR = 'Sonar Range';
Blockly.Msg.SENSOR_TEMP = 'Temperature';
Blockly.Msg.UART_GET = 'uart1 getkey';
Blockly.Msg.MOTOR_SPEED = 'Speed';
Blockly.Msg.MOTOR_TURN = 'Turn';
Blockly.Msg.MOTOR_MOVE = 'Move';
Blockly.Msg.MOTOR_SPIN = 'Spin';
Blockly.Msg.GLCD_FILL_SCR = 'Fill Screen Color';
Blockly.Msg.GLCD_REC = 'GLCD Rectangle';
Blockly.Msg.GLCD_FILL_REC = 'GLCD Fill Rectangle';
Blockly.Msg.GLCD_CIR = 'GLCD CIRCLE';
Blockly.Msg.GLCD_FILL_CIR = 'GLCD Fill Circle';
Blockly.Msg.GLCD_FILL_LINE = 'GLCD Line';
Blockly.Msg.GLCD_FILL_ARC = 'GLCD Arc';
Blockly.Msg.GLCD_CLEAR = 'GLCD Clear Screen';
Blockly.Msg.GLCD_HEIGHT = 'Height:';
Blockly.Msg.GLCD_WIDTH = 'Width:';
Blockly.Msg.GLCD_COLOR = '  Color:';
Blockly.Msg.GLCD_X_AXIS = '                X:';
Blockly.Msg.GLCD_Y_AXIS = ' Y:';
Blockly.Msg.CENTER_X = '             Center X:';
Blockly.Msg.CENTER_Y = 'Center Y:';
Blockly.Msg.RADIUS = 'Radius:';
Blockly.Msg.START_X = 'Start X:';
Blockly.Msg.START_Y = 'Start Y:';
Blockly.Msg.END_X = 'End X:';
Blockly.Msg.END_Y = 'End Y';
Blockly.Msg.START_DEG = 'Start Degree:';
Blockly.Msg.END_DEG = 'End Degree:';
Blockly.Msg.TOOLTIP_MOVE = 'Motor Move Forward or Backward set speed 0-100.';
Blockly.Msg.TOOLTIP_SPIN = 'Motor Move Spin Right or Left, One side motor reverse spin. can set speed 0-100.';
Blockly.Msg.TOOLTIP_TURN = 'Motor Move Turn Right or Left, One side motor stop set speed 0-100.';
Blockly.Msg.TOOLTIP_FORWARD2 = 'This block can be adjusted speed forward 2 motor is different.';
Blockly.Msg.TOOLTIP_BACKWARD2 = 'This block can be adjusted speed backward 2 motor is different.';
Blockly.Msg.TOOLTIP_MOTORCHOOSE = 'This block can be adjusted motor various 1 motor, 6 motor and set speed 0-100.';
Blockly.Msg.TOOLTIP_AO = 'Stop all motor';