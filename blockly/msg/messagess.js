...
/// url - Information about the mathematical constants Pi (�?€), e, the golden ratio (�??), â?? 2, â?? 1/2, and infinity (â??).
Blockly.Msg.MATH_CONSTANT_HELPURL = 'https://en.wikipedia.org/wiki/Mathematical_constant';
/// tooltip - Provides the specified [https://en.wikipedia.org/wiki/Mathematical_constant mathematical constant].
Blockly.Msg.MATH_CONSTANT_TOOLTIP = 'Return one of the common constants: �?€ (3.141â€¦), e (2.718â€¦), �?? (1.618â€¦), sqrt(2) (1.414â€¦), sqrt(Â½) (0.707â€¦), or â?? (infinity).';
